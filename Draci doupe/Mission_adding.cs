...
namespace Draci_doupe
{
    public class Mission_adding
    {
        ...
        {
            List<Mission> missions = new List<Mission>();
            missions.Add(new Mission(1) { Done = false, Level = 1, Text_Mission = "ahoj :)", Mission_description = "musis tohle", Enemy_HP = 500, Enemy_Attack = 50, Enemy_defense = 5, Enemy_name = "mocný idiot", Enemy_Strenght = 5, Name_Mission = "sejmi idiota", Reward = 100 });
            missions.Add(new Mission(2) { Done = true, Level = 2, Text_Mission = "ahodgdfj :)", Mission_description = "a tady zas tohle", Enemy_HP = 40, Enemy_Attack = 60, Enemy_defense = 4, Enemy_name = "idiot", Enemy_Strenght = 4, Name_Mission = "sejmi", Reward = 500 });
            return missions;
        }*/
